...
namespace Engine
{
	...
	public:
		...
		void Circle2(int x, int y, float points, float radius, Color color);
		...
		void GunText(int x, int y, bool center, bool shadow, Color color, const char* format, ...);
